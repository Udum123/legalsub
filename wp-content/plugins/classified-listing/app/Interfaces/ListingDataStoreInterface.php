...
interface ListingDataStoreInterface {


    /**
     * Returns a list of product IDs ( id as key => parent as value) that are
     * featured. Uses get_posts instead of rtcl_get_listings since we want
     ...
     *
     * @param Listing $listing Variable product object.
     * @param array      $match_attributes Array of attributes we want to try to match.
     * @return int Matching variation ID or 0.
     */
    public function find_matching_product_variation( $listing, $match_attributes = array() );
