...
do_action('rtcl_email_header', $email); ?>
    ...
    <p><?php printf(__('Your listing <strong>%s</strong> is expired on %s. You can renew it here: %s', 'classified-listing'), $listing->get_the_title(), $email->get_placeholders_item('{site_link}'), $email->get_placeholders_item('{renewal_link}')) ?></p>
<?php
